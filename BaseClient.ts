...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.VobizEnvironment | string>;
    /** Specify a custom URL to connect the client to. */
    baseUrl?: core.Supplier<string>;
    /** Override the X-Auth-ID header */
    authId: core.Supplier<string>;
    /** Override the X-Auth-Token header */
